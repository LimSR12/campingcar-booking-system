...
public class StaffDelete extends JDialog {
    private final StaffDao dao; private final Runnable ref;
    private final JTextField tfCond=new JTextField(30);

    public StaffDelete(Frame p, StaffDao dao, Runnable ref){
        super(p,"조건식에 해당하는 staff 삭제",true);
    ...
    private void init(){
        ...
        cond.setBorder(BorderFactory.createTitledBorder("조건식 (예: role = '사무')"));
